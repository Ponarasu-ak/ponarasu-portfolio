      ...
      <div className="h-full w-full flex items-center justify-center ">
        ...
        >
          ...
          <div className="grid grid-rows-1 gap-4 ">
            <div className="bg-white/15 backdrop-blur-3xl border border-white/10 text-white p-4 flex flex-col gap-4">
              <h2 className="text-lg font-semibold">Blogs</h2>
              <div className="flex flex-col gap-2">
              {[
                { title: "Understanding React Hooks", link: "#" },
                { title: "CSS Grid vs Flexbox", link: "#" },
                { title: "JavaScript ES6 Features", link: "#" },
                { title: "Building Accessible Web Apps", link: "#" },
                { title: "Optimizing React Performance", link: "#" },
              ].map((blog, idx) => (
                <a
                key={idx}
                href={blog.link}
